...
\begin{remarkdefinition}
  ...
  \begin{enumerate}
    \item
      A \emph{representation}~$X$\index{representation!of a quiver}\index{quiver!representation} of~$Q$ (over~$\kf$) consists of the following data:
      \begin{itemize}
        \item
  ...
  \begin{enumerate}[resume]
    \item
      ...
      \[
        \begin{tikzcd}
            X_{s(\alpha)}
            \arrow{r}[above]{X_\alpha}
            \arrow{d}[left]{\id_{X_{s(\alpha)}}}
          & X_{t(\alpha)}
            \arrow{d}[right]{\id_{X_{t(\alpha)}}}
          \\
            X_{s(\alpha)}
            \arrow{r}[above]{X_\alpha}
          & X_{t(\alpha)}
      ...
      It holds for every homomorphism of representations~$f \colon X \to Y$ that both
      \[
          {\id_Y} \circ f
        = f
        \quad\text{and}\quad
    ...
    \item
      ...
      The homomorphism~$f$ is an isomorphism if and only if at every vertex~$i \in Q_0$ the component~$f_i$ is an isomorphism (of~{\modules{$\kf$}}).
  \end{enumerate}
...
\begin{proof}
  ...
  \begin{enumerate}
    \item
      ...
      We start by showing that the~{\module{$\kf Q$}}~$M$ is actually the internal direct sum of its~{\submodules{$\kf$}}~$\varepsilon_i M$:
      \begin{itemize}
        \item
...
\begin{definition*}
  An \emph{oriented cycle}\index{oriented!cycle}\index{cycle!oriented} in a quiver~$Q$ is a path~$p$ in~$Q$ of length~$\geq 1$ with~$s(p) = t(p)$.
\end{definition*}
...
\begin{remark}
  ...
  \begin{enumerate}
    ...
    \item
      If a~{\kalg}~$A$ is finitely generated as a~{\module{$\kf$}}, then an~{\module{$A$}}~$M$ is finitely generated as an~{\module{$A$}} if and only if it is finitely generated as a~{\module{$\kf$}}:
      ...
      If on the other hand~$M$ is finitely generated as a left~{\module{$A$}}, then there exists a surjective homomorphism of~{\modules{$A$}}~$A^n \to M$;
      the~{\module{$A$}}~$A^n$ is again finitely generated as a~{\module{$\kf$}}, and so~$M$ is finitely generated as a~{\module{$\kf$}}.
      
      It follows in particular that if~$Q$ has no oriented cycles then a~{\module{$\kf Q$}}~$M$ is finitely generated as a~{\module{$\kf Q$}} if and only if it is finitely generated as a~{\module{$\kf$}}.
    ...
    \item
      If~$(X^j)_{j \in J}$ is a family of representations~$X^j$ of~$Q$ over~$\kf$ then their \emph{direct sum}\index{direct sum of representations} is the representations~$\bigdsum_{j \in J} X^j$ of~$Q$ over~$\kf$ that is given at vertices by
      \[
