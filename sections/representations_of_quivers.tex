...
\begin{remark}
  ...
  \begin{enumerate}
    ...
    \item
      If a~{\kalg}~$A$ is finitely generated as a~{\module{$\kf$}} then a~{\module{$A$}}~$M$ is finitely generated as an~{\module{$A$}} if and only if it is finitely generated as a~{\module{$\kf$}}:
