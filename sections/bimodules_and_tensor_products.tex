...
\begin{definition}
  ...
  \begin{enumerate}
    ...
    \item
      ...
      There exists for every~{\module{$\kf$}}~$P$ and every~{\balanced{$A$}} map~$\varphi \colon M \to N \to P$ a unique~{\klin} map~$f \colon M \times N \to T$ with~$f \circ \tau = \varphi$, i.e.\ such that the following diagram commutes:
      \[
