...
\begin{remark*}
  ...
  \begin{enumerate}
    ...
    \item
      Pullbacks are also known as \emph{fibre products}\index{fibre!product}, and the fibre product of two morphisms~$X \xto{f} Y \xfrom{g} Y'$ is then denoted by~$X \times_Y Y'$.
