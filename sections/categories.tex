...
\begin{example}
  ...
  \begin{enumerate}
    ...
    \item
      Let~$G$ be a group.
      We can then define a category~$\Gcat$ that consists of a single object~$\Ob(\Gcat) = \{ \ast \}$, the single morphism set~$\Gcat(\ast,\ast) = G$, and for which the composition of morphisms is the multiplication of~$G$, i.e.\ the composition is given as
      \[
                  g \circ h
        \defined  gh
      \]
