...
\begin{example*}
  ...
  Let~$\Ccat$ be a category and let~$2$ denote the category that consists of two objects~$0$ and~$1$, and where exist precisely one \dash{non}{idenity} morphism, namely~$\alpha \colon 0 \to 1$.
