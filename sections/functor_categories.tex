...
\begin{example*}
  ...
  Let~$\Ccat$ be a category and let~$2$ denote the category that consists of two objects~$0$ and~$1$, and in which there exists precisely one \dash{non}{identity} morphism, namely~$\alpha \colon 0 \to 1$.
