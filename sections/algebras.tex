...
\begin{remark}
  ...
  \begin{enumerate}[resume]
    \item
      Let~$A$ and~$B$ be~{\kalgs} and let~$f \colon A \to B$ be a homomorphism of rings.
  ...
  \begin{enumerate}
    \item
      ...
      \[
        ...
        \mapsto f \circ g \,.
      \]
      Then~$\End_\kf(V)$ is a ring and becomes a~{\kalg} via the ring homomorphism
      \[
                \tilde{\varphi}
        \colon  \kf
        \to     \End_\kf(V) \,,
...
\begin{definition}
  ...
  \begin{itemize}
    ...
    \item
      The elements~$\alpha \in Q_1$ are the \emph{arrows}\index{arrow} of~$Q$.
    \item
...
\begin{example}
  ...
  \begin{enumerate}
    \item
      ...
      \footnote{The third and fourth elements of the quadruple~$(\{1\}, \emptyset, \emptyset, \emptyset)$ refer to the empty function~$\emptyset \to \{1\}$.}
      \[
        \begin{tikzcd}
          1
        \end{tikzcd}
...
\begin{definition*}
  A quiver~$Q$ is \emph{finite}\index{finite}\index{quiver!finite} if both~$Q_0$ and~$Q_1$ are finite.
\end{definition*}
...
\begin{definition}
  ...
  \begin{enumerate}
    ...
    \item
      ...
      If~$t(p) = s(q)$ then the \emph{composition}\index{composition of paths}~$q \circ p$ of~$p$ after~$q$ is defined as the path
      \[
          q \circ p
...
\begin{remark*}
  ...
  We can then define the composite of two such paths~$(k \mid \beta_{\ell_2} \dotsm \beta_1 \mid j)$ and~$(j \mid \alpha_{\ell_1} \dotsm \alpha_1 \mid i)$ in~$Q$ as the path
  \[
...
\begin{proof}
  ...
  It therefore suffices to construct an injective homomorphism of~{\kalgs}~$\varphi \colon A \to \End_\kf(A)$.
  Let~$a \in A$.
  Then the map
  \[
            \varphi(a)
  ...
  \end{itemize}
  This altogether shows the claim.
\end{proof}
